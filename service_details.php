...
//single data for menu service
$sql_single_service = "SELECT * FROM service WHERE id = {$id}";
$result_single_service = $conn->query($sql_single_service);


//service menu
$sql_serv_view = "SELECT * FROM service WHERE status ORDER BY id DESC";
...
<section class="ulockd-service-details">
    <div class="container">	
        <div class="col-lg-3 ulockd-pdng0">
            <div class="service-widget">
                ...
                <div class="list-group">
                    ...
                    ?>
                    <a href="service_details.php?service_id=<?php echo $rows_of_serv['id']; ?>" class="list-group-item <?php echo $active; ?>"><?php echo $rows_of_serv['title']; ?></a>
                    <?php
                        } } else {
                            echo "No Data Found !";
                        }
        ...
        <?php
            if($result_single_service->num_rows > 0) {
                while ($rows_single_service = $result_single_service->fetch_assoc()) {
        ?>
        <div class="col-lg-9">
            <div class="row">
                <div class="col-md-12 ulockd-mrgn1210">
                    <div class="ulockd-project-sm-thumb">
                        <img class="img-responsive img-whp" src="admin/upload/service/<?php echo $rows_single_service['image']; ?>" alt="1.jpg">
                    </div>
                </div>
            </div>
            <div class="row clearfix">
                <div class="col-md-12 ulockd-mrgn1210 clearfix">
                    <div class="ulockd-pd-content">
                        <h3><?php echo $rows_single_service['title']; ?></h3>
                        <p class="project-dp-one"><?php echo $rows_single_service['detail']; ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="ulockd-dvidr-btn text-uppercase"><a class="btn btn-default ulockd-btn-white hvr-overline-from-center" href="appointment.html">Get Appointment</a></div>
            </div>
        </div>
    </div>
</section>
